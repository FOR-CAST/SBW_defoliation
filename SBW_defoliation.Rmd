...
subtitle: "v.`r SpaDES.core::moduleMetadata(module = 'SBW_defoliation', path = '..')$version`"
...
```{r setup-SBW-defoliation, include=FALSE}
...
`r paste(as.character(SpaDES.core::moduleMetadata(module = "SBW_defoliation", path = '..')$authors), sep = ', ')`
...
```{r moduleInputs-SBW-defoliation, echo = FALSE, eval = TRUE, message = FALSE, warning = FALSE}
df_inputs <- SpaDES.core::moduleInputs("SBW_defoliation", "/home/achubaty/Documents/GitHub/FOR-CAST/SBW_EasternBoreal/modules")
knitr::kable(df_inputs,
             caption = "List of (ref:SBW-defoliation) input objects and their description.") |>
...
```{r moduleParams-SBW-defoliation, echo = FALSE, eval = TRUE, message = FALSE, warning = FALSE}
df_params <- SpaDES.core::moduleParams("SBW_defoliation", "/home/achubaty/Documents/GitHub/FOR-CAST/SBW_EasternBoreal/modules")
knitr::kable(df_params, caption = "List of (ref:SBW-defoliation) parameters and their description.") |>
  kableExtra::kable_styling(latex_options = "scale_down", full_width = TRUE)
```
...
```{r moduleOutputs-SBW-defoliation, echo = FALSE, eval = TRUE, message = FALSE, warning = FALSE}
df_outputs <- SpaDES.core::moduleOutputs("SBW_defoliation", "/home/achubaty/Documents/GitHub/FOR-CAST/SBW_EasternBoreal/modules")
knitr::kable(df_outputs, caption = "List of (ref:SBW-defoliation) outputs and their description.") |>
  kableExtra::kable_styling(latex_options = "scale_down", full_width = TRUE)
```
